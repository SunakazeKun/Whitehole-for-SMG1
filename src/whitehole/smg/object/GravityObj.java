...
public class GravityObj extends TObject {
    private static final List<String> CHOICES_POWER = new ArrayList() {{ add("Normal"); add("Light"); add("Heavy"); }};
    private static final List<String> CHOICES_GRAVITY_TYPE = new ArrayList() {{ add("Normal"); add("Shadow"); add("Magnet"); }};
    
    public GravityObj(ZoneArchive zone, String layer, Bcsv.Entry entry) {
        this.zone = zone;
        this.layer = layer;
    ...
    public GravityObj(ZoneArchive zone, String layer, String objname, Vector3 pos) {
        this.zone = zone;
        this.layer = layer;
    ...
    public void getProperties(PropertyGrid panel) {
        ...
        panel.addField("Power", "Power", "list", CHOICES_POWER, data.get("Power"), "Default");
        panel.addField("Gravity_type", "Type", "list", CHOICES_GRAVITY_TYPE, data.get("Gravity_type"), "Default");
