...
public class CutsceneObj extends TObject {
    public CutsceneObj(ZoneArchive zone, String layer, Bcsv.Entry entry) {
        this.zone = zone;
        this.layer = layer;
    ...
    public CutsceneObj(ZoneArchive zone, String layer, String objname, Vector3 pos) {
        this.zone = zone;
        this.layer = layer;
