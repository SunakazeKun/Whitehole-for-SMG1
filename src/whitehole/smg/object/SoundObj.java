...
public class SoundObj extends TObject {
    public SoundObj(ZoneArchive zone, String layer, Bcsv.Entry entry) {
        this.zone = zone;
        this.layer = layer;
    ...
    public SoundObj(ZoneArchive zone, String layer, String objname, Vector3 pos) {
        this.zone = zone;
        this.layer = layer;
