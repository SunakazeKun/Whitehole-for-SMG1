...
public class ExternalFile extends MemoryFile {
    private final File baseFile;
    
    public ExternalFile(File basefile) throws IOException {
        super(Yaz0.decompress(Files.readAllBytes(basefile.toPath())));
    ...
    public void save() throws IOException {
        Files.write(baseFile.toPath(), Yaz0.compress(getContents()));
    }
}
